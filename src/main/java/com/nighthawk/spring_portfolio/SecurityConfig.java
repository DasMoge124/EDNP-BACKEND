...
public class SecurityConfig extends WebSecurityConfigurerAdapter {
	...
	public CorsConfigurationSource corsConfigurationSource() {
		...
		configuration.setAllowedOrigins(Arrays.asList("https://soham360.github.io")); // Add other allowed origins if
																						// needed
	...
	protected void configure(HttpSecurity httpSecurity) throws Exception {
		httpSecurity
				...
				.addHeaderWriter(new StaticHeadersWriter("Access-Control-Allow-Origin", "https://soham360.github.io",
						"http://localhost:4100"))
				.and()
				.formLogin()
				.loginPage("/login")
